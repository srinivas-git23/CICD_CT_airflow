...
bucket = storage_client.bucket("mlops-airflow-7032")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "mlops-450323.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://mlops-airflow-7032/bank-campaign-training-data.csv"
    model_name = 'xgboost'
